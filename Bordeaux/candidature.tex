...
\newpage
\input{./projet_enseignement}

\newpage
\phantomsection\addcontentsline{toc}{section}{Rapport de soutenance de thèse}
...
\phantomsection\addcontentsline{toc}{section}{Rapport de thèse de Mme Laure Petrucci}
...
\phantomsection\addcontentsline{toc}{section}{Rapport de thèse de M. Igor Walukiewicz}
...
\phantomsection\addcontentsline{toc}{section}{Lettre de soutien (recherche) des encadrants de thèse}
...
\phantomsection\addcontentsline{toc}{section}{Lettre de soutien (recherche) de M. Fabrice Kordon}
...
\phantomsection\addcontentsline{toc}{section}{Lettre de soutien (enseignement) de M. Didier Le Botlan}
...
\phantomsection\addcontentsline{toc}{section}{Lettre de soutien (enseignement) de Mme Pauline Ribot}
