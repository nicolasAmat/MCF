...
doctorat, ainsi que leurs \hln{extensions}, qui sont l'un des premiers modèles
...
% Chaque théorie a aussi ses caractéristiques propres et, parfois, ses approches
% dédiées. En règle générale, la théorie des réseaux de Petri accorde une même
% importance aux états et aux événements, alors que les algèbres de
% processus~\cite{hoare_communicating_1978,milner_calculus_1980}, par exemple,
% tentent d'abstraire la notion d'état pour se concentrer plutôt sur les
% événements et des notions d'équivalences comportementales.
% %%
...
ensembles de vecteurs booléens. Cependant, ces techniques sont \hln{limitées aux
réseaux bornés} et, en pratique, ne sont pas à la hauteur des \hl{approches
