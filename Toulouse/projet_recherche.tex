...
\hl{\underline{Ouverture du projet :}} Il est envisageable d'étendre ce projet à
...
pour les \hln{réseaux de Petri colorés}, où des informations sont attachées à
...
par l'étude de \hln{certificats d'invariance}, comme j'ai pu le proposer dans
